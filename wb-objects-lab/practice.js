...
//Code Here
function greaterThan10(myObject) {
...
//Code Here
for (let index in deleteTheBigNumbers) {
  if (deleteTheBigNumbers[index] > 100) {
    delete deleteTheBigNumbers[index]
  }
}
...
function usCanadaBorder(coordinates) {
  ...
  if (latitude === 49 && longitude <= -95 && longitude >= -123) {
    return true
  } else {
    return false
  }
